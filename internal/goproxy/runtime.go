...
func (r *runtimeAdapter) ProbeCapability() ecosystem.Capability {
	return ecosystem.UnsupportedCapability("go proxy probe is not implemented", r.Upstreams())
}

func (r *runtimeAdapter) PrefetchCapability() ecosystem.Capability {
	return ecosystem.UnsupportedCapability("go proxy prefetch is not implemented", r.Upstreams())
}
