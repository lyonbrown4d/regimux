ALTER TABLE "meta_pulls" ADD COLUMN "policy_denied_count" BIGINT NOT NULL DEFAULT 0;
ALTER TABLE "meta_pulls" ADD COLUMN "last_policy_denied_at" BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE "meta_repositories" ADD COLUMN "policy_denied_pull_count" BIGINT NOT NULL DEFAULT 0;
ALTER TABLE "meta_repositories" ADD COLUMN "last_policy_denied_at" BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE "meta_upstreams" ADD COLUMN "policy_denied_pull_count" BIGINT NOT NULL DEFAULT 0;
ALTER TABLE "meta_upstreams" ADD COLUMN "last_policy_denied_at" BIGINT NOT NULL DEFAULT 0;
