...
func defaultValues() map[string]any {
	return map[string]any{
		...
		"scheduler.distributed_lock":                      true,
		"scheduler.lock_ttl":                              5 * time.Minute,
		"scheduler.cleanup.enabled":                       true,
		"scheduler.cleanup.interval":                      time.Hour,
		"scheduler.cleanup.max_scan":                     0,
		"scheduler.cleanup.unused_for":                    168 * time.Hour,
		"scheduler.cleanup.max_deletes":                   1000,
		"scheduler.cleanup.dry_run":                       false,
		"scheduler.cleanup.distributed":                   false,
		"scheduler.prefetch.enabled":                      false,
		"scheduler.prefetch.interval":                     30 * time.Minute,
		"scheduler.prefetch.max_records":                  200,
		"scheduler.prefetch.min_pull_count":               2,
		"scheduler.prefetch.tags_page_size":               1000,
		...
		"upstreams.hub.blob.mirror_policy":                "ordered",
		"upstreams.hub.blob.top_n":                        3,
		"upstreams.hub.blob.max_concurrency_per_endpoint": 0,
		"upstreams.hub.probe.enabled":                     false,
		"upstreams.hub.probe.interval":                    30 * time.Second,
		"upstreams.hub.probe.timeout":                     3 * time.Second,
		"upstreams.hub.probe.cooldown":                    2 * time.Minute,
