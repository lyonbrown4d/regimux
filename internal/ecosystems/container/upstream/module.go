...
var Module = dix.NewModule("container-upstream",
	...
	dix.Hooks(
		dix.OnStart[*Client](loadClientEndpointHealth, dix.LifecycleName("regimux.container_upstream_health_load"), dix.LifecyclePriority(-50)),
		dix.OnStop[*Client](flushClientEndpointHealth, dix.LifecycleName("regimux.container_upstream_health_flush"), dix.LifecyclePriority(-55)),
		dix.OnStop[*EndpointClients](closeEndpointClients, dix.LifecycleName("regimux.container_upstream_endpoint_clients_close"), dix.LifecyclePriority(-60)),
	),
)
