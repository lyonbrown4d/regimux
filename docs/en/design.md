...
RegiMux is a read-only OCI / Docker Registry V2 proxy mirror gateway. It exposes a Registry-compatible pull API while routing requests to configured upstream registries by alias.
